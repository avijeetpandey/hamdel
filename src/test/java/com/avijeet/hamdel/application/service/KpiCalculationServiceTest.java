...
class KpiCalculationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new KpiCalculationService(telemetryRepository, metricsRepository, new SimpleMeterRegistry());
    }
    ...
    void processBatch_calculatesCorrectVst() {
        ...
        var captor = ArgumentCaptor.forClass(com.avijeet.hamdel.domain.model.SessionMetrics.class);
    ...
    private HeartbeatEventProto event(double vst, boolean failed, double rebuf, double playback) {
